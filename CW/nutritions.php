...
$results = mysql_query("SELECT product_code, product_name, product_desc, product_img_name, price, product_qty FROM products WHERE id BETWEEN 25 AND 32 ORDER BY id ASC");
	...
	if($count>0){
		...
		while($row = mysql_fetch_array($results)){
			...
			<form action="" method="post">
				<tr height="250"><td><img src = "images/'.$productImage.'" style="width:200px;height:200px;"></td>			
